...
pub fn close_term(state: &mut TopLevelState, inactive_validators: &[Address]) -> StateResult<()> {
    ...
    update_candidates(state, current_term, nomination_expiration, inactive_validators)
}
