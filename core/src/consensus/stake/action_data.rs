...
pub fn get_account_key(address: &Address) -> H256 {
    ActionDataKeyBuilder::new(2).append(&"Account").append(address).into_key()
}

lazy_static! {
    pub static ref STAKEHOLDER_ADDRESSES_KEY: H256 =
        ActionDataKeyBuilder::new(1).append(&"StakeholderAddresses").into_key();
    pub static ref CANDIDATES_KEY: H256 =
        ActionDataKeyBuilder::new(1).append(&"Candidates").into_key();
    pub static ref JAIL_KEY: H256 = ActionDataKeyBuilder::new(1).append(&"Jail").into_key();
    pub static ref BANNED_KEY: H256 =
        ActionDataKeyBuilder::new(1).append(&"Banned").into_key();
    pub static ref NEXT_VALIDATORS_KEY: H256 =
        ActionDataKeyBuilder::new(1).append(&"Validators").into_key();
    pub static ref CURRENT_VALIDATORS_KEY: H256 =
        ActionDataKeyBuilder::new(1).append(&"CurrentValidators").into_key();
}

pub fn get_delegation_key(address: &Address) -> H256 {
    ActionDataKeyBuilder::new(2).append(&"Delegation").append(address).into_key()
}
